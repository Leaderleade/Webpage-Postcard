      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <h3 className="text-xl sm:text-2xl font-bold mb-4">Hatchmee</h3>
            <p className="text-western-desert mb-6 max-w-md text-sm sm:text-base">
              Bringing the warmth and character of the romance and love via our Postcard designs.
          ...
          <div>
            ...
            <ul className="space-y-2 text-western-desert text-sm sm:text-base">
              <li>
                <Link to="/work" className="hover:text-western-orange transition-colors">Gallery</Link>
              </li>
              <li>
                <Link to="/shop" className="hover:text-western-orange transition-colors">Kickerstater Page</Link>
              </li>
              {/* <li>
